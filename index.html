...
Encoding your message is easy, the idea with enciphering, is to make is hard to decode.
...
hat is shuffling everything too.
...
**You can do much better by merging the two functions into one.**
 ...
 To make sure you only shift against alphabetic letters, you can include the alphabet in your program.
